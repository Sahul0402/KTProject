...
import AddUser from './container/User/addUser.jsx';
import Books from './container/Books/books.jsx';
import AddBook from './container/Books/addBook.jsx';
import BookDetails from './container/Books/bookDetails.jsx';
import AddBookDetails from './container/Books/addbookDetails.jsx';
import XtraBookDetails from './container/Books/xtraBookDetails.jsx';
  ...
  <BrowserRouter>
    <React.Suspense fallback={<Loader/>}>
      ...
      <Route path={`${import.meta.env.BASE_URL}`} element={<Auth />}>
          ...
          <Route path={`${import.meta.env.BASE_URL}User/user`} element={<User/>} />
          <Route path={`${import.meta.env.BASE_URL}User/adduser`} element={<AddUser/>} />
          <Route path={`${import.meta.env.BASE_URL}Books/books`} element={<Books/>} />
          <Route path={`${import.meta.env.BASE_URL}Books/addBook`} element={<AddBook/>} />
          <Route path={`${import.meta.env.BASE_URL}Books/bookDetails`} element={<BookDetails/>} />
          <Route path={`${import.meta.env.BASE_URL}Books/addbookDetails`} element={<AddBookDetails/>} />
          <Route path={`${import.meta.env.BASE_URL}Books/xtraBookDetails`} element={<XtraBookDetails/>} />
