...
import {
  ...
  init_clsx,
  init_composeClasses
} from "./chunk-RDVBV3JV.js";
import {
  useTheme
} from "./chunk-E4DHFWMD.js";
import {
  HTMLElementType,
  alpha,
  chainPropTypes,
...
} from "./chunk-AFCMLVUD.js";
import "./chunk-ZSCNLU6M.js";
import "./chunk-OI7M3FX2.js";
import {
  _extends,
...
var Slider3 = React75.forwardRef(function Slider4(inputProps, ref) {
  ...
  return (0, import_jsx_runtime52.jsxs)(RootSlot, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime51.jsx)(RailSlot, _extends({}, railProps)), (0, import_jsx_runtime51.jsx)(TrackSlot, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min && mark.value <= max).map((mark, index2) => {
      const percent = valueToPercent(mark.value, min, max);
      const style = axisProps2[axis].offset(percent);
      let markActive;
      if (track === false) {
      ...
      return (0, import_jsx_runtime52.jsxs)(React75.Fragment, {
        children: [(0, import_jsx_runtime51.jsx)(MarkSlot, _extends({
          "data-index": index2
        ...
        })), mark.label != null ? (0, import_jsx_runtime51.jsx)(MarkLabelSlot, _extends({
          "aria-hidden": true,
          "data-index": index2
      ...
      return (
        ...
        (0, import_jsx_runtime51.jsx)(ValueLabelComponent, _extends({}, !isHostComponent(ValueLabelComponent) && {
          valueLabelFormat,
          valueLabelDisplay,
          ...
          children: (0, import_jsx_runtime51.jsx)(ThumbSlot, _extends({
            "data-index": index2
          }, thumbProps, {
            ...
            children: (0, import_jsx_runtime51.jsx)(InputSlot, _extends({
              "data-index": index2,
              "aria-label": getAriaLabel ? getAriaLabel(index2) : ariaLabel,
              "aria-valuenow": scale(value),
              "aria-labelledby": ariaLabelledby,
...
true ? Slider3.propTypes = {
  ...
  componentsProps: import_prop_types32.default.shape({
    ...
    valueLabel: import_prop_types32.default.oneOfType([import_prop_types32.default.func, import_prop_types32.default.shape({
